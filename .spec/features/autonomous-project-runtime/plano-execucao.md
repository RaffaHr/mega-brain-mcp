...
> gerado por `onp-spec plano` em 2026-08-25 13:21 — NÃO edite à mão;
> mudou tasks.md ou a config? Regenere: `onp-spec plano autonomous-project-runtime --sequencial`

## Resumo — o que vai acontecer

- **modo SEQUENCIAL (escolha do usuário)**: 3 tarefa(s) pendente(s), UMA APÓS A OUTRA, na árvore principal (4 já concluída(s): T-024, T-025, T-029, T-026)
